package Core.Actor.Entity
{
	...
	/**
	 * Author : 苍白的茧
	 * Date : 2013-12-16 下午2:48:36
	 */
	public class Ladder extends ActorBase
	{
		public function Ladder(textureAtlas:TextureAtlas)
		{
			super(textureAtlas);
			
			m_image = new Image(textureAtlas.getTexture("ladder"));
